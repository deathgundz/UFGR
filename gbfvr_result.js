document.addEventListener('DOMContentLoaded', function () {
    const topThreeList = document.getElementById('top-three-gbfvr-list');

    // Retrieve top three ratings from local storage
    const topThreeRatings = JSON.parse(localStorage.getItem('topThreegbfvrRatings'));
    ...
    if (topThreeRatings) {
        ...
        topThreeList.textContent = 'Top three ratings not been detreimn yet .';
    }
});
